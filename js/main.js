...
const translations = {
  sr: {
    ...
    t1_author: '- Iva R.',
    t2_text: 'Dugogodišnji sam klijent dr Dragane i mogu iskreno da kažem da sam prezadovoljna uslugom i rezultatima. Profesionalnost, ljubaznost i posvećenost pacijentu su ono što je čini posebnom.',
    t2_author: '- Bojana M.',
    t3_text: 'Ja sam neko ko se mnogo plasi igala i uvijek sam izbjegavala sve sto ukljucuje injekcije, dok nisam dosla kod dr Dragane. Njen pristup je toliko paziljivaj i njezno da sam zaboravila na strah.',
    t3_author: '- Milica J.',
  ...
  en: {
    ...
    t1_author: '- Iva R.',
    t2_text: 'I have been a long-time client of Dr. Dragana and I can sincerely say that I am very satisfied with the service and results. Professionalism, kindness and dedication to the patient are what make her special.',
    t2_author: '- Bojana M.',
    t3_text: 'I am someone who is very afraid of needles and always avoided anything involving injections, until I came to Dr. Dragana. Her approach is so careful and gentle that I forgot about my fear.',
    t3_author: '- Milica J.',
